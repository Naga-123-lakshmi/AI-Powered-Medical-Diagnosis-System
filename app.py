...
models = {
    'diabetes': pickle.load(open('/content/diabetes_model.sav', 'rb')),
    'heart_disease': pickle.load(open('/content/heart_disease_model.sav', 'rb')),
    'parkinsons': pickle.load(open('/content/parkinsons_model.sav', 'rb')),
    'lung_cancer': pickle.load(open('/content/lungs_disease_model.sav', 'rb')),
    'thyroid': pickle.load(open('/content/Thyroid_model.sav', 'rb'))
}
